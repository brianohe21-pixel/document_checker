...
gcloud builds submit \
  ...
  --substitutions="_REGION=${GCP_REGION},_ARTIFACT_REPO=${GCP_ARTIFACT_REPO},_TAG=${TAG},_NEXT_PUBLIC_API_URL=${GCP_API_URL},_NEXT_PUBLIC_DONATE_GITHUB_URL=${NEXT_PUBLIC_DONATE_GITHUB_URL:-},_NEXT_PUBLIC_DONATE_CRYPTO_ADDRESS=${NEXT_PUBLIC_DONATE_CRYPTO_ADDRESS:-},_NEXT_PUBLIC_DONATE_CRYPTO_LABEL=${NEXT_PUBLIC_DONATE_CRYPTO_LABEL:-},_NEXT_PUBLIC_DONATE_KOFI_URL=${NEXT_PUBLIC_DONATE_KOFI_URL:-},_NEXT_PUBLIC_CONTACT_NAME=${NEXT_PUBLIC_CONTACT_NAME:-},_NEXT_PUBLIC_CONTACT_WHATSAPP=${NEXT_PUBLIC_CONTACT_WHATSAPP:-}"
